...
log = setup_logging()
app = FastAPI(title="Gen Scene Studio Backend", version="0.3.0")
...
# Start worker in a background thread to avoid ASGI lifespan issues
...
# Start worker immediately when module loads
start_worker_thread()
